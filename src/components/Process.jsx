      ...
      <div className="flex flex-col gap-20 xl:flex-row">
        ...
        <div className="flex flex-1 flex-col justify-center">
          <h4 className="h3 max-w-[411px]">
            Order Your Favourite Food in just a Few Clicks
          </h4>
          <p>
            Experience the convenience of ordering delicious meals anytime,
            anywhere. Follow these simple steps and have your favourite food
          ...
          <div className="my-7 flex flex-col gap-4">
            ...
            <div className="flexStart gap-x-4">
              ...
              <p>Choose your favourites item and add them to your cart.</p>
            </div>
            <div className="flexStart gap-x-4">
              <span className="bg-secondary text-white h-6 w-6 p-1.5 flexCenter rounded-full">
                <GiCheckMark />
            ...
            <div className="flexStart gap-x-4">
              ...
              <p>
                Stay updated with real-time tracking ultil your food arrives.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* right side */}
        <div className="flex flex-1 gap-6 xl:gap-12">
          <div>
